...
function InstagramIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <circle cx="17.4" cy="6.6" r="1" fill="url(#ig2)" />
    </svg>
  );
}
...
function CheckIcon() {
  return (
    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M7 12l3.5 3.5 6.5-7" stroke="#22c55e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
// ── SSO button ───────────────────────────────────────────────────────────────
function SSOButton({ provider, icon, label, className }: {
  provider: string; icon: React.ReactNode; label: string; className: string;
}) {
  ...
  return (
    <motion.button
      ...
      disabled={busy}
      onClick={async () => { setBusy(true); await signIn(provider, { callbackUrl: "/" }); }}
...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    setError(null);
    // Wire to your own API route / Prisma create
          ...
          <AnimatePresence mode="wait">
            ...
            {done ? (
              <motion.div
                ...
                className="w-full max-w-[400px] flex flex-col items-center text-center gap-5"
              >
                <motion.div
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">Your account has been set up successfully.</p>
                </div>
              ...
              >
                ...
                <motion.div variants={fadeUp} className="mb-8">
                  ...
                  <p className="text-sm text-slate-500">Join the NEO Prediction System</p>
                </motion.div>
                ...
                <motion.div variants={fadeUp} className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-xs text-slate-700">or sign up with email</span>
                  <div className="flex-1 h-px" style={{ background: "#0f1e38" }} />
                </motion.div>
                ...
                >
                  <div>
                    <label className="block text-[11px] font-semibold tracking-[0.1em] uppercase mb-1.5" style={{ color: "#4a6080" }}>
                      Name
                    </label>
                    <input
                ...
                <motion.p variants={fadeUp} className="mt-7 text-center text-sm text-slate-600">
                  ...
                  <Link href="/signin" className="text-blue-500 hover:text-blue-400 transition-colors font-medium">
                    Sign in
                  </Link>
                </motion.p>
